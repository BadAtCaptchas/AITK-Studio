...
Covers t2v (t2va), spatial first-frame i2v (fl2va), and vision-token
reference conditioning (ref2va), always denoising the joint audio stream
alongside the video (the packed sequence contains audio rows by construction;
decoding the audio track is optional).
