...
class BaseSDTrainProcess(BaseTrainProcess):
        ...
        with torch.no_grad():
            ...
            with self.timer('prepare_latents'):
                ...
                if batch.tensor is not None:
                    imgs = batch.tensor
                    # Preserve waveform precision before the audio encoder.
                    input_dtype = torch.float32 if getattr(self.sd, 'is_audio_model', False) else dtype
                    imgs = imgs.to(self.device_torch, dtype=input_dtype)
            ...
            with self.timer('prepare_timesteps_indices'):
                ...
                if self.train_config.noise_scheduler == 'flowmatch' and self.train_config.timestep_type == 'shifted_logit_normal':
                    ...
                    else:  # The outer guard restricts this to eight_step.
    ...
    def load_optimizer_state(self):
        ...
        print_acc('Updating optimizer LR from params')
