    ...
    def sample(self, step=None):
        ...
        with torch.no_grad():
            for i, img_url in enumerate(self.sample_sources):
                ...
                output_img = output_img.resize((output_img.width * scale_up, output_img.height * scale_up), Image.Resampling.NEAREST)
