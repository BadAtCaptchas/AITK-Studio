...
def main():
    global SPEED_SHAPES, VRAM_BLOCKS, VRAM_BLOCK_SHAPES, VRAM_TOKENS, STACK_KEY
    ...
    ap.add_argument(
        "--quick",
        action="store_true",
        help="use reduced representative shapes for a fast hardware smoke benchmark",
    )
    args = ap.parse_args()
