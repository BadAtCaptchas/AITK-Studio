...
BaseModel.print_and_status_update so every holder status line â€” "Loading
transformer", "Quantizing (convrot8)", "Loading VAE", ... â€” opens a new
stage). For every stage it records:
  ...
  - cpu_avg_pct /    process CPU utilization (100 = one full core), sampled
    cpu_max_pct      at 50ms â€” this is what shows where quantization burns CPU
