...
ARCH_REGISTRY: Dict[str, dict] = {
    ...
    "qwen_image_2": {"modality": "image", "model": {"name_or_path": "Qwen/Qwen-Image-2.1", "quantize": True, "quantize_te": True, "qtype": "convrot8", "qtype_te": "convrot8", "low_vram": True}, "sample": {**IMG, "num_inference_steps": 20, "guidance_scale": 1.0}},
...
OUTPUT_EXT = {"image": "png", "video": "mp4", "audio": "mp3", "text": "txt"}
