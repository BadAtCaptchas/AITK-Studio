...
import { flushCache, normalizeBooleanSetting } from '@/server/settings';
...
import {
  ...
  normalizeExternalComfyLoraDir,
  normalizeExternalComfyUrl,
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    settingsObject.COMFY_EXTERNAL_LORA_DIR = normalizeExternalComfyLoraDir(
      settingsObject.COMFY_EXTERNAL_LORA_DIR || '',
    );
