    ...
    const profile: AutoTrainingProfile = {
      ...
      network: network
        ? {
            ...
            lokr_use_tucker: network.lokr_use_tucker,
            lokr_use_scalar: network.lokr_use_scalar,
            lokr_decompose_both: network.lokr_decompose_both,
            lokr_rank_dropout_scale: network.lokr_rank_dropout_scale,
            lokr_weight_decompose: network.lokr_weight_decompose,
            lokr_wd_on_output: network.lokr_wd_on_output,
            lokr_full_matrix: network.lokr_full_matrix,
            lokr_bypass_mode: network.lokr_bypass_mode,
            lokr_rs_lora: network.lokr_rs_lora,
            lokr_unbalanced_factorization: network.lokr_unbalanced_factorization,
            lokr_legacy_factorization: network.lokr_legacy_factorization,
