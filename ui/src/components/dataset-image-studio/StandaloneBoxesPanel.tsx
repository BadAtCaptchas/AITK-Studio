...
export function StandaloneBoxesPanel({
  ...
  return (
    <section className="flex min-h-0 flex-col bg-gray-950 text-gray-100" aria-label="Boxes">
        ...
        <div className="relative flex-none">
          <button
            ...
            className={classNames(
              ...
              boxFilter === 'all' ? 'text-gray-400' : 'border-brand-800 text-brand-300',
            )}
          >
          ...
          {filterOpen ? (
            <div
              ...
              className="absolute right-0 top-9 z-20 w-36 overflow-hidden rounded-[4px] border border-gray-800 bg-gray-900 p-1 shadow-xl shadow-black/50"
            >
