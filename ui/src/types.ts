...
export interface TrainConfig {
  ...
  sega_distill?: boolean;
  sega_distill_weight?: number;
  sega_distill_base_resolution?: number;
  sega_distill_strength?: number;
  sega_distill_min_scale?: number;
  sega_distill_max_scale?: number;
  sega_distill_on_reg?: boolean;
...
export interface JobConfig {
  extensions?: Record<string, { modelArches?: string[]; processKinds?: string[] }>;
  job: string;
  config: ConfigObject;
  meta: MetaConfig;
}
